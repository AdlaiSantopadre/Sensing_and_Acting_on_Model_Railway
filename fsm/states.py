...
states = {
    ...
    "S_1_4": State("S_1_4", "00100001"),
    "S_2_4": State("S_2_4", "01000001"),
    "S_3_4": State("S_3_4", "10000001"),
    "S_1_1": State("S_1_1", "00100010"),
    "S_2_1": State("S_2_1", "01000010"),
    "S_3_1": State("S_3_1", "10000010"),
    "S_4_1": State("S_4_1", "00010010"),
    "S_2_2": State("S_2_2", "01000100"),
    "S_3_2": State("S_3_2", "10000100"),
    "S_4_2": State("S_4_2", "00010100"),
    "S_3_3": State("S_3_3", "10001000"),
    "S_4_3": State("S_4_3", "00011000"),
    "S_1_2": State("S_1_2", "00100100"),
    "S_1_3": State("S_1_3", "00101000"),
    "S_1_4_bis": State("S_1_4_bis", "00110000"),
    "S_2_2_bis": State("S_2_2_bis", "01000100"),
    "S_2_3": State("S_2_3", "01001000"),
    "S_2_4_bis": State("S_2_4_bis", "01010000"),
    ...
    "D_1_1_loop": State("D_1_1_loop", "11100001"),
...
import ace_tools as tools; tools.display_dataframe_to_user(name="Stati definiti in states.py", dataframe=df_states)
